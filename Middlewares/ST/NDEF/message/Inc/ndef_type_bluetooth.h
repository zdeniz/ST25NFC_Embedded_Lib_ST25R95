 ...
 *
 * It provides functionalities to handle Bluetooth Out-Of-Band NDEF records,
 * to start a communication based on Bluetooth.
 *
 * The Bluetooth OOB format is described by the Bluetooth v4.0 core specification.
 * It consists in a list of Extended Inquiry Responses (EIRs) formated as length-type-value.
 *
 * \addtogroup NDEF
 * @{
 *
